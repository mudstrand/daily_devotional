#!/usr/bin/env python3
"""
Daily Devotional Message Parser (batch 1712)
...
def main() -> None:
    ...
    ap.add_argument(
        ...
        help="Directory containing .txt messages (default: 1712)",
    )
    ap.add_argument(
        "--out",
        default=BatchConfig().out_json,
        help="Output JSON file (default: parsed_1712.json)",
    )
    args = ap.parse_args()
