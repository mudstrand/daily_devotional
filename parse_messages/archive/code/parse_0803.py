#!/usr/bin/env python3
"""
Daily Devotional Message Parser (batch 0803)
...
# Flexible date banner: allows "03/ 27/08", "03/27/08", "03/27/2008", and "11//19/08"
DATE_BANNER_RE = re.compile(
    ...
    (?:
        ...
        |
        \d{2}/\s*\d{2}/\d{2}(?:\d{2})?     # 03/27/08 or 03/ 27/2008
    )
    (?:
        \s*~\s*~\s*~\s*(?:~\s*)?
