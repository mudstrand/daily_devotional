#!/usr/bin/env python3
"""
Daily Devotional Message Parser (batch 0711)
...
# Optional date banner: allows "11/12/07", "11/ 12/2007", and "11//19/08"
DATE_BANNER_RE = re.compile(
    ...
    (?:
        ...
        |
        \d{2}/\s*\d{2}/\d{2}(?:\d{2})?     # 11/12/07 or 11/ 12/2007
    )
    (?:
        \s*~\s*~\s*~\s*(?:~\s*)?
