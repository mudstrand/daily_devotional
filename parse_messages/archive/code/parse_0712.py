#!/usr/bin/env python3
"""
Daily Devotional Message Parser (batch 0712)
...
# Optional date banner: allows "12/18/07", "12/ 18/2007", and "11//19/08"
DATE_BANNER_RE = re.compile(
    ...
    (?:
        ...
        |
        \d{2}/\s*\d{2}/\d{2}(?:\d{2})?     # 12/18/07 or 12/ 18/2007
    )
    (?:
        \s*~\s*~\s*~\s*(?:~\s*)?
