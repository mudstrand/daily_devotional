...
def main():
    ...
    ap = argparse.ArgumentParser(description='Parse 1907 devotionals (inline-friendly headings) into JSON')
    ap.add_argument(
        '--input-dir',
        default=DEFAULT_INPUT_DIR,
        help='Directory containing .txt messages (default: 1907)',
    )
    ap.add_argument('--out', default=OUT_JSON, help='Output JSON file (default: parsed_1907.json)')
    args = ap.parse_args()
