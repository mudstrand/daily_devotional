#!/usr/bin/env python3
"""
Daily Devotional Message Parser (batch 1801)
...
def main() -> None:
    ...
    ap.add_argument(
        ...
        help='Directory containing .txt messages (default: 1801)',
    )
    ap.add_argument(
        '--out',
        default=BatchConfig().out_json,
        help='Output JSON file (default: parsed_1801.json)',
    )
    args = ap.parse_args()
