#!/usr/bin/env python3
"""
Daily Devotional Message Parser (batch 1401)
...
def main() -> None:
    ...
    ap = argparse.ArgumentParser(description="Parse 1401 devotionals (Today's Verses/Thoughts/Prayer Suggestion)")
    ap.add_argument(
        '--input-dir',
        default=CFG.input_dir,
        help='Directory containing .txt messages (default: 1401)',
    )
    ap.add_argument(
        '--out',
        default=CFG.out_json,
        help='Output JSON file (default: parsed_1401.json)',
    )
    args = ap.parse_args()
