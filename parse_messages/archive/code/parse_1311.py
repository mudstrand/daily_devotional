#!/usr/bin/env python3
"""
Daily Devotional Message Parser (batch 1311)

Parses “Today’s Verses/Thoughts/Prayer Suggestion” notes.
...
class BatchConfig:
    input_dir: str = '1311'
    out_json: str = 'parsed_1311.json'
    header_body_sep: str = '=' * 67
    # accommodate "Pastor Al & Marcie Sather" and "Pastor Alvin and Marcie Sather"
...
def slice_todays_sections(body: str) -> tuple[str, str, str]:
    ...
    # If no “Today’s …” headers, leave empty (likely admin/forward)
...
def main() -> None:
    ...
    ap = argparse.ArgumentParser(description="Parse 1311 devotionals (Today's Verses/Thoughts/Prayer Suggestion)")
    ap.add_argument(
        '--input-dir',
        default=CFG.input_dir,
        help='Directory containing .txt messages (default: 1311)',
    )
    ap.add_argument(
        '--out',
        default=CFG.out_json,
        help='Output JSON file (default: parsed_1311.json)',
    )
    args = ap.parse_args()
