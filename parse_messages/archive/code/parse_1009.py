#!/usr/bin/env python3
"""
Daily Devotional Message Parser (batches 1009–1012)
...
DATE_BANNER_RE = re.compile(
    ...
    ^\s*
    (?:
        \d{2}/\d{2}/\d{4}        # 09/27/2010
        |
        \d{2}[^0-9]\d{2}/\d{4}  # 11?02/2010
        |
        \d{2}/\d{2}/\d{2}       # 10/17/24 (malformed but treated as banner)
    )
