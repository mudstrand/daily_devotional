#!/usr/bin/env python3
"""
Daily Devotional Message Parser (batch 0904)
...
# Dateline banner: mm/dd/yy or mm/dd/yyyy; optional FOOD FOR THOUGHT with 3–4 tildes or date + arbitrary title
...
def slice_sections(body: str) -> Tuple[str, str, str]:
    ...
    def block(start_idx: Optional[int], stops: List[Optional[int]]) -> str:
        ...
        # Trim trailing signature/tail lines within the block
