#!/usr/bin/env python3
"""
Daily Devotional Message Parser (batch 0911)

Parses “thoughts to live by” notes with structure:
-      Dateline banner: mm/dd/yy or mm/dd/yyyy (also tolerant of optional ~~~ FOOD FOR THOUGHT ~~~ title
      and date + title without that phrase; 3–4 tildes and optional spacing tolerated)
