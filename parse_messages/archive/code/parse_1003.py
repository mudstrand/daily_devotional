#!/usr/bin/env python3
"""
Daily Devotional Message Parser (batches 1003–1012)
...
-      Dateline banner: mm/dd/yyyy, mm?dd/yyyy, or mm/dd/yy, optionally followed by ~~~ FOOD FOR THOUGHT ~~~ title
      (allows 3–4 tildes to tolerate typos)
...
# Allow 3–4 tildes around the phrase to tolerate typos like "~~~~food".
