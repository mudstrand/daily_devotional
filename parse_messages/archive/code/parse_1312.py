#!/usr/bin/env python3
"""
Daily Devotional Message Parser (batch 1312)
...
class BatchConfig:
    input_dir: str = '1312'
    out_json: str = 'parsed_1312.json'
    header_body_sep: str = '=' * 67
    # signature lines vary slightly
...
def main() -> None:
    ...
    ap = argparse.ArgumentParser(description="Parse 1312 devotionals (Today's Verses/Thoughts/Prayer Suggestion)")
    ap.add_argument(
        '--input-dir',
        default=CFG.input_dir,
        help='Directory containing .txt messages (default: 1312)',
    )
    ap.add_argument(
        '--out',
        default=CFG.out_json,
        help='Output JSON file (default: parsed_1312.json)',
    )
    args = ap.parse_args()
