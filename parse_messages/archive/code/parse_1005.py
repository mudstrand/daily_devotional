#!/usr/bin/env python3
"""
Daily Devotional Message Parser (batches 1005–1012)
...
-     Dateline banner: mm/dd/yyyy, mm?dd/yyyy, or mm/dd/yy, optionally followed by ~~~ FOOD FOR THOUGHT ~~~ title
     (allows extra spaces around the tildes)
...
# Loosened to allow optional spaces around the ~~~ groups.
DATE_BANNER_RE = re.compile(
    r"""
    ^\s*
    (?:
        \d{2}/\d{2}/\d{4}        # 05/19/2010
        |
