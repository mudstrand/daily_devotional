#!/usr/bin/env python3
"""
Daily Devotional Message Parser (batches 1006–1012)
...
-       Prayer header: Prayer Suggestion or Suggested Prayer (tolerates minor typos)
...
# Prayer header variants (include minor typo “Pray Suggestion”)
PRAYER_HDR_RE = re.compile(
    r'^\s*(?:Prayer\s+Suggestion|Suggested\s+Prayer|Pray\s+Suggestion)\s*[:\-]?\s*$',
    re.IGNORECASE,
)
