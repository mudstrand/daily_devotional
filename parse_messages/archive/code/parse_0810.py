#!/usr/bin/env python3
"""
Daily Devotional Message Parser (batch 0810)
...
# - Our Bible Verse(s) for Today
# - Our Verses for Today
# - Our Bible Verse for Today
# - Our Verse for Today
# - Bible Verse(s) for Today (without "Our")
