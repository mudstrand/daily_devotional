...
def build_claude_messages(reflection: str, verse: str, reading: str) -> List[Dict[str, str]]:
    """
    ...
    for attempt in range(1, retries + 1):
        try:
            ...
            if attempt < retries:
                ...
                raise RuntimeError(f'Claude prayer generation failed after {retries} attempts: {e}') from e
