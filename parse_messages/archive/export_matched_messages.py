...
POS2_RE = re.compile(r'\b(thoughts?|lessons?)\b', re.IGNORECASE)  # thought(s) / lesson(s)
...
def slice_sections_by_positions(body: str, pos: List[Tuple[int, str]]) -> Dict[str, str]:
    """
