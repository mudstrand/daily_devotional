...
def main():
    ap = argparse.ArgumentParser(description='Download messages for IDs in a file and save to a folder')
    ap.add_argument(
        '--ids-file',
        default='missing_from_sqlite.ids',
